...
function validateInput () {
  ...
  else if (missedLettersArr.indexOf(keyPressedStr) === -1) {
    alert("You already selected this letter. Choose again.");
    validateInput();
  }
  else {
...
function evaluateGuess() {
  ...
  if (answerArrayArr.indexOf("_") === -1) { // checks array to see if there are any "_" if none, word was guessed
    ...
    // could also use remainingLettersInt = 0)  
    loseGame();
  }
  else {
    continueGame();
